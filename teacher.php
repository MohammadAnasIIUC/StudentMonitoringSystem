...
<div id="admin">
        ...
        <div id="lmain">
                ...
                <div id="leftmanu">
					...
					<div >
                        <a href="?tag=home" title="HOME (Shift+Ctrl+H)">Schedule</a><br />
                	</div>
					<div >
    	...
    	<div id="pic_manu">
         ...
         <div id="menu2">
           ...
           <li id="li_menu"><a href="">Remarks</a>
                    ...
                    <ul>
                        <li id="li_submenu"><a href="teacher.php?tag=score_entry" class="customer"> Update remarks</a></li>
                        
                        <li id="li_submenu"><a href="teacher.php?tag=view_scores" class="order">View remarks</a></li>
                    </ul>
                ...
                <li id="li_menu"><a href="">Task</a>
                    ...
                    <ul>
                           <li id="li_submenu"><a href="?tag=artical_entry" class=" sales">Update Task</a></li>
