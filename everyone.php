         ...
         <div id="menu2">
           ...
           <li id="li_menu"><a href="">Remarks</a>
                    ...
                    <ul>
                        ...
                        <li id="li_submenu"><a href="everyone.php?tag=score_entry" class="customer">Update Remarks</a></li>
                        <li id="li_submenu"><a href="everyone.php?tag=view_scores" class="order">View Remarks</a></li>
                    </ul>
                ...
                <li id="li_menu" style="border-right:#CCC"><a href="">Users</a>
                    ...
                    <ul>
                        ...
                        <li id="li_submenu"><a href="student.php?tag=view_users" class="sales">View Users</a></li>
